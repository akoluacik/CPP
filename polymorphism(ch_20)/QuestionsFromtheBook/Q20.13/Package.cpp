...
Package::Package( std::string name, std::string senderAddress, std::string recipientAddress, std::string city, 
                  std::string state, std::string senderZipCode, 
                  std::string recipientZipCode,
                  double _weight, double _costPerOunce)
        :name(name), senderAddress(senderAddress), recipientAddress(recipientAddress), city(city),
...
void Package::setSenderAddress( std::string& senderAddress) {
...
void Package::setRecipientAddress( std::string& recipientAddress) {
...
void Package::print() const {
    std::cout << "Name              : " << name << std::endl
              ...
              << "Recipient Address : " << recipientAddress << std::endl
              << "City              : " << city << std::endl
